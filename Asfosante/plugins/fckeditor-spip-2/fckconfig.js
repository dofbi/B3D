...
// ajout YATY multimédia
// crée FCKConfig.BasePath sans le nom de domaine
// Editor Base Path
...
//FCKConfig.Plugins.Add( 'spipcode' ) ;
//FCKConfig.Plugins.Add( 'placeholder' ) ;
FCKConfig.AutoGrowMax = 400 ;
FCKConfig.Plugins.Add( 'imgmap', 'fr,en,es' ) ;
FCKConfig.Plugins.Add( 'spipdoc', 'fr,en' ) ;

//FCKConfig.Plugins.Add( 'placeholder', 'fr' ) ;
...
FCKConfig.ToolbarSets["Default"] = [
	...
	'/',
	['Style','FontFormat','-'],['FontName','FontSize'], // modif YATY multimédia : ajout séparateur ],[
	['TextColor','BGColor'],
...
FCKConfig.ToolbarSets["Spip"] = [
	...
	['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
	['Link','Unlink','Anchor'],
	['SpipImg','Image','imgmapPopup'],
	['SpipDoc','Flash','Table','Rule','Smiley','SpecialChar','PageBreak'],  // modif YATY multimédia : ajout 'PageBreak'
	['TextColor','BGColor'],
...
FCKConfig.ToolbarSets["Configurable"] = [
// CFG:TOOLBAR:START
['Source','DocProps','-','Save','NewPage','Templates','-','Preview','Print'],
['Cut','Copy','Paste','PasteText','PasteWord'],
['Undo','Redo','-','Find','Replace','-','SelectAll','RemoveFormat'],'/',
['Bold','Italic','Underline','StrikeThrough','-','Subscript','Superscript','-','TextColor','BGColor','-','SpecialChar'],
['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','OrderedList','UnorderedList','-','Table','Rule','-'],['Outdent','Indent','Blockquote','CreateDiv'],
['Link','SpipLink','Unlink','Anchor'],
['SpipImg','Image','imgmapPopup','Smiley'],
['SpipDoc','Flash'],
...
FCKConfig.EnterMode = 'p' ;			// p | div | br // modif YATY multimédia
...
FCKConfig.FontNames		= 'serif;sans-serif;cursive;fantasy;monospace;Arial;Comic Sans MS;Courier New;Tahoma;Times New Roman;Verdana' ;
FCKConfig.FontSizes		= 'smaller;larger;xx-small;x-small;small;medium;large;x-large;xx-large' ;

FCKConfig.StylesXmlPath		= FCKConfig.EditorPath + 'fckstyles.xml' ;
FCKConfig.TemplatesXmlPath	= FCKConfig.EditorPath + 'fcktemplates.xml' ;

FCKConfig.SpellChecker			= 'ieSpell' ;	// 'WSC' | 'SCAYT' | 'SpellerPages' | 'ieSpell'
...
FCKConfig.IndentLength = 20 ; // modif YATY multimédia
...
FCKConfig.LinkUpload = false ; // modif YATY multimédia
FCKConfig.LinkUploadURL = FCKConfig.BasePath + 'filemanager/connectors/' + _QuickUploadLanguage + '/upload.' + _QuickUploadExtension ;
FCKConfig.LinkUploadAllowedExtensions	= ".(7z|aiff|asf|avi|bmp|csv|doc|fla|flv|gif|gz|gzip|jpeg|jpg|mid|mov|mp3|mp4|mpc|mpeg|mpg|ods|odt|pdf|png|ppt|pxd|qt|ram|rar|rm|rmi|rmvb|rtf|sdc|sitd|swf|sxc|sxw|tar|tgz|tif|tiff|txt|vsd|wav|wma|wmv|xls|xml|zip)$" ;			// empty for all
FCKConfig.LinkUploadDeniedExtensions	= "" ;	// empty for no one

FCKConfig.ImageUpload = false ; // modif YATY multimédia
FCKConfig.ImageUploadURL = FCKConfig.BasePath + 'filemanager/connectors/' + _QuickUploadLanguage + '/upload.' + _QuickUploadExtension + '?Type=Image' ;
FCKConfig.ImageUploadAllowedExtensions	= ".(jpg|gif|jpeg|png|bmp)$" ;		// empty for all
FCKConfig.ImageUploadDeniedExtensions	= "" ;							// empty for no one

FCKConfig.FlashUpload = false ; // modif YATY multimédia
