...
(function($) {
  ...
  SexyLightbox = {
    //Modif FR : Pour savoir si une instance de SexyLightbox a déjà été lancée
    ...
    backwardcompatibility: function(option) {
	  ...
	  this.options.OverlayStyles = $.extend(this.options.Skin[this.rootColor], this.options.OverlayStyles || {});
    },
    ...
    initialize: function(options) {
	  ...
	  //Modif FR : RootColor est la couleur après avoir extrait la langue
	  this.rootColor=this.options.color.substr(0, this.options.color.length-3);
	  //Modif FR : Assigner la variable exists
	  this.exists=true;
      ...
      this.overlay.create({
		...
		style       : this.options.Skin[this.rootColor],
        hideOnClick : true,
      ...
      this.Contenido.css({
		...
		'border-left-color' : this.options.Skin[this.rootColor].hexcolor,
        'border-right-color': this.options.Skin[this.rootColor].hexcolor
      });
      ...
      this.Nav.css({
		...
		'color'     : this.options.Skin[this.rootColor].captionColor
      });
